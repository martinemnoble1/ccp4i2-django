...
class CTaskManager:
    ...
    def __init__(self):
        ...
        defxml_path = os.path.join(dir_path, "defxml_lookup.json")
        plugin_path = os.path.join(dir_path, "plugin_lookup.json")
...
def main():
    ...
    if args.rebuild:
        dir_path = os.path.dirname(os.path.abspath(__file__))
        defxml_script = os.path.join(dir_path, "defxml_lookup.py")
