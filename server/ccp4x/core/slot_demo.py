...
async def demonstrate_slots():
    ...
    for slot_name, slot_info in processor_slots.items():
        arg_types = ", ".join(t.__name__ for t in slot_info.arg_types) if slot_info.arg_types else "None"
        result_type = slot_info.result_type.__name__ if slot_info.result_type else "None"
