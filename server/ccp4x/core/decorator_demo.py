...
from signal_system import Signal, Slot, SignalDecorator, auto_connect_slots, get_slots, get_signals
...
async def demonstrate_decorators():
    ...
    # Update an item
    model.update_item(1, {"name": "Phenix Job", "value": "R=0.189", "status": "completed"})
