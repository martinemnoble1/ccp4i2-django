...
@cdata_class(
    attributes={
            ...
            "crystalName": attribute(AttributeType.STRING, tooltip="crystalName attribute"),
            "dataset": attribute(AttributeType.STRING, tooltip="dataset attribute"),
            "excludeSelection": attribute(AttributeType.STRING, tooltip="excludeSelection attribute"),
        },
    qualifiers={
            "toolTip": "Imported data file, cell parameters and crystal/dataset identifiers",
            "helpFile": "import_merged#file_formats",
...
@cdata_class(
    attributes={
            ...
            "listOfColumns": attribute(AttributeType.STRING, tooltip="listOfColumns attribute"),
            "datasets": attribute(AttributeType.STRING, tooltip="datasets attribute"),
            "crystalNames": attribute(AttributeType.STRING, tooltip="crystalNames attribute"),
            "wavelengths": attribute(AttributeType.STRING, tooltip="wavelengths attribute"),
            "datasetCells": attribute(AttributeType.STRING, tooltip="datasetCells attribute"),
...
@cdata_class(
    attributes={
            "name": attribute(AttributeType.STRING, tooltip="name attribute"),
            "columnGroups": attribute(AttributeType.STRING, tooltip="columnGroups attribute"),
        },
    gui_label="CMtzDataset"
)
...
@cdata_class(
    attributes={
            ...
            "knownwavelength": attribute(AttributeType.BOOL, tooltip="knownwavelength attribute"),
